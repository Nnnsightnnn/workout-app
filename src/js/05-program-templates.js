...
const PROGRAM_TEMPLATES = [
  ...
  { id:"jbrown3", name:"Functional Conjugate", description:"2 heavy full-body days + 1 speed day with conditioning.", daysPerWeek:3, minWeeks:8, maxWeeks:12, totalWeeks:null, phases:null },
  { id:"filly4", name:"Functional Bodybuilding", description:"Tempo-driven upper/lower with giant sets.", daysPerWeek:4, minWeeks:8, maxWeeks:12, totalWeeks:null, phases:null },
  ...
  { id:"kot3", name:"Full ROM Joint Health", description:"Joint health first — full ROM, progressive knee conditioning.", daysPerWeek:3, minWeeks:8, maxWeeks:12, totalWeeks:null, phases:null },
  { id:"hybrid5", name:"Hybrid Athlete", description:"Concurrent strength + endurance. Don't sacrifice either.", daysPerWeek:5, minWeeks:8, maxWeeks:12, totalWeeks:null, phases:null },
  { id:"prvn4", name:"Strength + MetCon GPP", description:"Strength block + MetCon per session. Periodized general fitness.", daysPerWeek:4, minWeeks:8, maxWeeks:12, totalWeeks:null, phases:null },
  { id:"wendler4", name:"5/3/1 Wave Progression", description:"Classic 5/3/1 waves — 3-week cycles with AMRAP sets + BBB accessories.", daysPerWeek:4, minWeeks:8, maxWeeks:12, totalWeeks:null, phases:null },
  { id:"gzcl4", name:"Tiered Progression", description:"Tiered training — T1 heavy, T2 moderate, T3 pump. Structured progression.", daysPerWeek:4, minWeeks:8, maxWeeks:12, totalWeeks:null, phases:null },
  { id:"ss3", name:"Novice Linear Progression", description:"Squat every session, simple compounds, add weight each time.", daysPerWeek:3, minWeeks:8, maxWeeks:12, totalWeeks:null, phases:null },
  ...
  {
    id: "rp-hypertrophy",
    name: "Volume Landmark Hypertrophy",
    description: "Volume landmark mesocycle: ramps from MEV to MRV over 4-6 weeks. Per-muscle landmarks, RIR targets, and exercise rotation.",
    daysPerWeek: 4,
    minWeeks: 4,
    maxWeeks: 6,
    totalWeeks: 5,
