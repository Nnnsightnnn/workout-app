...
const LIBRARY = [
  ...
  { id:"treadmill", name:"Treadmill", muscles:["conditioning"], cat:"Warmup", defaultRest:0, defaultSets:1, defaultReps:400, isDistance:true, bodyweight:true, noRpe:true, defaultWeight:0, demoUrl:"" },
  ...
  { id:"thoracicrot", name:"Thoracic Rotation", muscles:["thoracic","upper back"], cat:"Warmup", defaultRest:0, defaultSets:2, defaultReps:8, bodyweight:true, noRpe:true, perSide:true, defaultWeight:0, demoUrl:"https://www.youtube.com/watch?v=RbS0I94VEuM" },
  { id:"spiderman", name:"Spiderman Lunge", muscles:["hips","hip flexors","thoracic"], cat:"Warmup", defaultRest:0, defaultSets:2, defaultReps:5, bodyweight:true, noRpe:true, perSide:true, defaultWeight:0, demoUrl:"https://www.youtube.com/watch?v=aqwCEOhiEgs" },
  // Cooldown / Stretching
  { id:"hipflexorstretch", name:"Hip Flexor Stretch", muscles:["hip flexors","quads"], cat:"Warmup", defaultRest:0, defaultSets:1, defaultReps:45, bodyweight:true, isTime:true, noRpe:true, perSide:true, defaultWeight:0, demoUrl:"" },
  { id:"hamstringstretch", name:"Hamstring Stretch", muscles:["hamstrings"], cat:"Warmup", defaultRest:0, defaultSets:1, defaultReps:45, bodyweight:true, isTime:true, noRpe:true, perSide:true, defaultWeight:0, demoUrl:"" },
  { id:"pigeonpose", name:"Pigeon Pose", muscles:["hips","glutes","hip flexors"], cat:"Warmup", defaultRest:0, defaultSets:1, defaultReps:60, bodyweight:true, isTime:true, noRpe:true, perSide:true, defaultWeight:0, demoUrl:"" },
  { id:"childpose", name:"Child's Pose", muscles:["shoulders","hips","thoracic"], cat:"Warmup", defaultRest:0, defaultSets:1, defaultReps:60, bodyweight:true, isTime:true, noRpe:true, defaultWeight:0, demoUrl:"" },
  // Extra Accessories
  ...
  { id:"atgsplit", name:"ATG Split Squat", muscles:["quads","glutes","hip flexors"], cat:"Squat", defaultRest:60, defaultSets:3, defaultReps:8, perSide:true, defaultWeight:0, bodyweight:true, demoUrl:"https://www.youtube.com/watch?v=KxSLsvO_jBY" },
  { id:"slantboardsquat", name:"Slant Board Squat", muscles:["quads","knees"], cat:"Squat", defaultRest:60, defaultSets:3, defaultReps:10, defaultWeight:0, bodyweight:true, demoUrl:"https://www.youtube.com/watch?v=hQz2kaLwSEM" },
  { id:"poliquat", name:"Poliquin Step-Up", muscles:["quads","knees"], cat:"Squat", defaultRest:45, defaultSets:3, defaultReps:10, perSide:true, defaultWeight:10, demoUrl:"https://www.youtube.com/watch?v=6_gC5TJjZEg" },
  { id:"reversesled", name:"Backward Sled Drag", muscles:["quads","knees","conditioning"], cat:"Carry", defaultRest:60, defaultSets:4, defaultReps:1, isDistance:true, defaultWeight:45, demoUrl:"https://www.youtube.com/watch?v=yL8W1jJBnHE" },
];
